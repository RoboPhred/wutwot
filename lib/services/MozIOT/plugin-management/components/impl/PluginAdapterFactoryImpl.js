...
let PluginAdapterFactoryImpl = class PluginAdapterFactoryImpl {
    constructor(_thingService, _actionService, _requestService) {
        this._thingService = _thingService;
        this._actionService = _actionService;
        this._requestService = _requestService;
    }
    createPluginAdapter(plugin) {
        return new PluginAdapterImpl_1.PluginAdapterImpl(plugin, this._thingService, this._actionService, this._requestService);
    }
};
PluginAdapterFactoryImpl = __decorate([
    ...
    __param(2, microinject_1.inject(action_requests_1.ActionRequestService))
