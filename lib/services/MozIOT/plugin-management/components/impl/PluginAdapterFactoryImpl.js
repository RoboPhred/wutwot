...
let PluginAdapterFactoryImpl = class PluginAdapterFactoryImpl {
    constructor(_thingFactory, _thingRepository, _actionFactory, _actionRepository) {
    ...
    createPluginAdapter(plugin) {
        return new PluginAdapterImpl_1.PluginAdapterImpl(plugin, this._thingFactory, this._thingRepository, this._actionFactory, this._actionRepository);
    }
};
