...
let ThingManagerImpl = class ThingManagerImpl extends events_1.EventEmitter {
    ...
    _onThingAdded(source, e) {
        ...
        const context = Object.assign({}, e.thingDef, { thingId: externalId, thingOwnerThingId: e.thingId, thingOwner: source, metadata: e.thingDef.metadata ? lodash_1.cloneDeep(e.thingDef.metadata) : {} });
